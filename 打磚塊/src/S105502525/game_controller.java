...
public class game_controller {
	...
	private ImageView gameover;
	 ...
	 private double rectangleSpeedX = 0 ; // pixels per second
	    ...
	    public game_controller (gmanager Gmanager)
	    {
	 ...
	 private void initialize() {
		 ...
		 Gmanager.set_gc(canvas.getGraphicsContext2D ());
	        rectangleAnimation = new AnimationTimer() {
	            ...
	            public void handle(long timestamp) {
	                ...
	                Gmanager.draw(timestamp);
	           
              

                   if( Gmanager.isCollisionWith(ball.getTranslateX(),ball.getTranslateY())==1){
                	   i=-i; 
                   }
                   else if( Gmanager.isCollisionWith(ball.getTranslateX(),ball.getTranslateY())==2){
                	   j=-j; 
                   }
